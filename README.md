...
| **neural** | `configs/neural.toml` | classic's, plus the word-strip CRNN + CTC scorer (285k params; more as adopted) | Best accuracy: broad-30 93.5 char / 87.4 word vs classic 91.8 / 82.0; legal-8 92.2 / 84.3 vs 91.7 / 81.2; modern 91.5 / 85.7 vs 89.6 / 80.8; news-8 93.5 / 87.3 vs 92.6 / 81.8 (docs/DESIGN.md §8, docs/RESEARCH.md). |
