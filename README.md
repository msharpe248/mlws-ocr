...
| **neural** | `configs/neural.toml` | classic's, plus the word-strip CRNN + CTC scorer (285k params; more as adopted) | Best accuracy: broad-30 93.6 char / 86.8 word vs classic 91.7 / 81.5; legal-8 97.1 / 92.3 vs 96.7 / 90.2; modern 91.7 / 86.3 vs 89.7 / 81.2 (docs/RESEARCH.md). |
