...
MODELS = {
    ...
    "seq_line_gray_en.npz": "line reader, reads GREY strips (decode.line_source = gray), ensemble member 1 = seq_line_gray2 seed 3 (v17a seed 3 fine-tuned 8 epochs on grey line strips + the binary SROIE / Legal Reports / FUNSD line files)",
