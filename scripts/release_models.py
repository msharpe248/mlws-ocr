...
MODELS = {
    ...
    "seq_line_en.npz": "line reader CRNN+CTC, ensemble member 1 = seq_line_v17a seed 3 (train_seq.py; long synthetic lines + whole UNLV, SROIE receipt and CORD photographed-receipt lines at weight 5, FUNSD form and Library of Congress Legal Reports lines)",
