...
page-disjoint holdout).  A word whose boundaries the alignment could not
match is not a label; junk output words with no truth counterpart are
therefore not represented -- the calibrator learns to rank readings of
real words, and the output stage's garbage gate keeps handling junk.
