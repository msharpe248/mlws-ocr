...
1. ~~A modern test set, and our number on it.~~ BUILT and measured
   ...
   (production slug, glued line numbers and split small-caps names removed): **83.6 / 70.5 /
   88.0 recall / 88.8 precision** against legacy 72.0 / 67.5 / 92.0 /
   95.7 — we lead by 11.6 char and 3.0 word; the remaining gap is
