...
| business | invoices, payslips, receipts, statements, orders | **97.2 / 93.4** | 70.7 / 68.0 | 70.7 / 68.6 | ahead by 26 characters; level on bag-of-words recall (96.9 vs 97.5 / 98.0) |
...
- **Where we lead, we lead by a lot.** Typewriter pleadings, modern
  documents and tabular business pages are four to twenty-six character
